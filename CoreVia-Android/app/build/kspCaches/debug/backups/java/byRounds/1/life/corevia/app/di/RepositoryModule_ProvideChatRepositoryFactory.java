...
public final class RepositoryModule_ProvideChatRepositoryFactory implements Factory<ChatRepository> {
  ...
  public RepositoryModule_ProvideChatRepositoryFactory(Provider<ApiService> apiServiceProvider) {
  ...
  public static RepositoryModule_ProvideChatRepositoryFactory create(
    ...
    return new RepositoryModule_ProvideChatRepositoryFactory(apiServiceProvider);
  }

  public static ChatRepository provideChatRepository(ApiService apiService) {
    return Preconditions.checkNotNullFromProvides(RepositoryModule.INSTANCE.provideChatRepository(apiService));
  }
}
