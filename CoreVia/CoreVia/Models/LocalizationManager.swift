...
class LocalizationManager: ObservableObject {
    ...
    private let strings: [String: [AppLanguage: String]] = [
        ...
        "food_water_tracking": [.az: "Su İzləmə", .en: "Water Tracking", .ru: "Отслеживание воды"],
        "food_choose_source": [.az: "Şəkil Mənbəyi", .en: "Image Source", .ru: "Источник изображения"],
        "food_source_camera": [.az: "Kamera", .en: "Camera", .ru: "Камера"],
        "food_source_gallery": [.az: "Qalereya", .en: "Gallery", .ru: "Галерея"],
        ...
        // Delete Account
        "delete_account_title": [.az: "Hesab\u{0131} Sil", .en: "Delete Account", .ru: "\u{0423}\u{0434}\u{0430}\u{043B}\u{0438}\u{0442}\u{044C} \u{0430}\u{043A}\u{043A}\u{0430}\u{0443}\u{043D}\u{0442}"],
        "delete_account_warning": [.az: "Hesab\u{0131}n\u{0131}z v\u{0259} b\u{00FC}t\u{00FC}n m\u{0259}lumatlar\u{0131}n\u{0131}z h\u{0259}mi\u{015F}\u{0259}lik silin\u{0259}c\u{0259}k. Bu \u{0259}m\u{0259}liyyat geri qaytarila bilm\u{0259}z!", .en: "Your account and all data will be permanently deleted. This action cannot be undone!", .ru: "\u{0412}\u{0430}\u{0448} \u{0430}\u{043A}\u{043A}\u{0430}\u{0443}\u{043D}\u{0442} \u{0438} \u{0432}\u{0441}\u{0435} \u{0434}\u{0430}\u{043D}\u{043D}\u{044B}\u{0435} \u{0431}\u{0443}\u{0434}\u{0443}\u{0442} \u{0443}\u{0434}\u{0430}\u{043B}\u{0435}\u{043D}\u{044B} \u{043D}\u{0430}\u{0432}\u{0441}\u{0435}\u{0433}\u{0434}\u{0430}. \u{042D}\u{0442}\u{043E} \u{0434}\u{0435}\u{0439}\u{0441}\u{0442}\u{0432}\u{0438}\u{0435} \u{043D}\u{0435}\u{043B}\u{044C}\u{0437}\u{044F} \u{043E}\u{0442}\u{043C}\u{0435}\u{043D}\u{0438}\u{0442}\u{044C}!"],
        "delete_account_confirm_desc": [.az: "T\u{0259}sdiqlamaq \u{00FC}\u{00E7}\u{00FC}n \u{015F}ifr\u{0259}nizi daxil edin. Bu \u{0259}m\u{0259}liyyat geri qaytarila bilm\u{0259}z.", .en: "Enter your password to confirm. This action cannot be undone.", .ru: "\u{0412}\u{0432}\u{0435}\u{0434}\u{0438}\u{0442}\u{0435} \u{043F}\u{0430}\u{0440}\u{043E}\u{043B}\u{044C} \u{0434}\u{043B}\u{044F} \u{043F}\u{043E}\u{0434}\u{0442}\u{0432}\u{0435}\u{0440}\u{0436}\u{0434}\u{0435}\u{043D}\u{0438}\u{044F}. \u{042D}\u{0442}\u{043E} \u{0434}\u{0435}\u{0439}\u{0441}\u{0442}\u{0432}\u{0438}\u{0435} \u{043D}\u{0435}\u{043B}\u{044C}\u{0437}\u{044F} \u{043E}\u{0442}\u{043C}\u{0435}\u{043D}\u{0438}\u{0442}\u{044C}."],
        "delete_account_password": [.az: "\u{015E}ifr\u{0259}niz", .en: "Your Password", .ru: "\u{0412}\u{0430}\u{0448} \u{043F}\u{0430}\u{0440}\u{043E}\u{043B}\u{044C}"],
        "delete_account_password_placeholder": [.az: "\u{015E}ifr\u{0259}nizi daxil edin", .en: "Enter your password", .ru: "\u{0412}\u{0432}\u{0435}\u{0434}\u{0438}\u{0442}\u{0435} \u{043F}\u{0430}\u{0440}\u{043E}\u{043B}\u{044C}"],
        "delete_account_confirm": [.az: "Hesab\u{0131} Sil", .en: "Delete Account", .ru: "\u{0423}\u{0434}\u{0430}\u{043B}\u{0438}\u{0442}\u{044C} \u{0430}\u{043A}\u{043A}\u{0430}\u{0443}\u{043D}\u{0442}"],
        "delete_account_error": [.az: "Hesab silin\u{0259}rk\u{0259}n x\u{0259}ta ba\u{015F} verdi", .en: "Error deleting account", .ru: "\u{041E}\u{0448}\u{0438}\u{0431}\u{043A}\u{0430} \u{043F}\u{0440}\u{0438} \u{0443}\u{0434}\u{0430}\u{043B}\u{0435}\u{043D}\u{0438}\u{0438} \u{0430}\u{043A}\u{043A}\u{0430}\u{0443}\u{043D}\u{0442}\u{0430}"],
        ...
        "student_tasks_title": [.az: "Tapşırıqlar", .en: "Tasks", .ru: "Задания"],
        "student_tasks_add": [.az: "Əlavə et", .en: "Add", .ru: "Добавить"],
        "student_tasks_for": [.az: "üçün tapşırıq", .en: "task for", .ru: "задание для"],
        "student_tasks_type": [.az: "Tapşırıq növü", .en: "Task type", .ru: "Тип задания"],
        "student_tasks_name": [.az: "Tapşırıq adı", .en: "Task name", .ru: "Название задания"],
        "student_tasks_name_placeholder": [.az: "məs: 30 dəq qaçış", .en: "e.g: 30 min run", .ru: "напр: 30 мин бег"],
        "student_tasks_description": [.az: "Əlavə qeyd", .en: "Description", .ru: "Описание"],
        "student_tasks_new": [.az: "Yeni Tapşırıq", .en: "New Task", .ru: "Новое задание"],
        "student_tasks_empty": [.az: "Hələ tapşırıq yoxdur", .en: "No tasks yet", .ru: "Заданий пока нет"],
        "task_type_workout": [.az: "Məşq", .en: "Workout", .ru: "Тренировка"],
        "task_type_nutrition": [.az: "Qidalanma", .en: "Nutrition", .ru: "Питание"],
        "task_type_lifestyle": [.az: "Həyat tərzi", .en: "Lifestyle", .ru: "Образ жизни"],
        ...
        "onboarding_body_title": [.az: "Bədən Məlumatları", .en: "Body Information", .ru: "Информация о теле"],
        "onboarding_body_subtitle": [.az: "Daha dəqiq nəticələr üçün məlumatlarınızı daxil edin", .en: "Enter your details for more accurate results", .ru: "Введите данные для более точных результатов"],
        "onboarding_years": [.az: "yaş", .en: "years", .ru: "лет"],
        "bmi_underweight": [.az: "Arıq", .en: "Underweight", .ru: "Недовес"],
        "bmi_normal": [.az: "Normal", .en: "Normal", .ru: "Норма"],
        "bmi_overweight": [.az: "Artıq çəki", .en: "Overweight", .ru: "Избыточный вес"],
        "bmi_obese": [.az: "Piylənmə", .en: "Obese", .ru: "Ожирение"],
        "home_ai_recommendation": [.az: "AI Tövsiyə", .en: "AI Recommendation", .ru: "AI Рекомендация"],
        "ai_rec_no_workout_title": [.az: "Bu gün məşq etməmisən!", .en: "No workout today!", .ru: "Сегодня без тренировки!"],
        "ai_rec_no_workout_desc": [.az: "Hərəkətdə qalmaq vacibdir. 15-20 dəqiqəlik yüngül məşqlə başlaya bilərsən.", .en: "Staying active is important. Try starting with a 15-20 min light workout.", .ru: "Активность важна. Начните с 15-20 мин лёгкой тренировки."],
        "ai_rec_goal_done_title": [.az: "Əla iş! Hədəfə çatdın! 🎉", .en: "Great job! Goal reached! 🎉", .ru: "Отлично! Цель достигнута! 🎉"],
        "ai_rec_goal_done_desc": [.az: "Bu gün bütün məşqləri tamamladın. Sabah da belə davam et!", .en: "You completed all workouts today. Keep it up tomorrow!", .ru: "Все тренировки на сегодня выполнены. Продолжайте завтра!"],
        "ai_rec_eat_more_title": [.az: "Daha çox qidalanmaq lazımdır", .en: "You need to eat more", .ru: "Нужно больше есть"],
        "ai_rec_eat_more_desc": [.az: "Bu gün az kalori qəbul etmisən. Enerjini bərpa etmək üçün sağlam qida əlavə et.", .en: "You've consumed few calories today. Add healthy food to restore energy.", .ru: "Сегодня мало калорий. Добавьте здоровую еду для восстановления энергии."],
        "ai_rec_keep_going_title": [.az: "Yaxşı gedirsən! 💪", .en: "Keep going! 💪", .ru: "Продолжай! 💪"],
        "ai_rec_keep_going_desc": [.az: "Hədəfə yaxınlaşırsan. Davam et və bu gün tamamla!", .en: "You're getting closer. Keep going and finish today!", .ru: "Ты приближаешься к цели. Продолжай и завершай сегодня!"],
        "ai_rec_motivation": [.az: "Motivasiya", .en: "Motivation", .ru: "Мотивация"],
